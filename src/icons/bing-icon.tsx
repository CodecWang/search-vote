export default function BingIcon({ className }: IconProps) {
  return (
    <svg
      className={className}
    ...
    >
      ...
      >
        <stop offset="0" stopColor="#3dbffc"></stop>
        <stop offset="1" stopColor="#183efb"></stop>
      </linearGradient>
      <path
      ...
      >
        ...
        <stop offset=".159" stopColor="#32b9f0"></stop>
        <stop offset=".341" stopColor="#2facf2"></stop>
        <stop offset=".533" stopColor="#2a95f4"></stop>
        <stop offset=".733" stopColor="#2475f6"></stop>
        <stop offset=".936" stopColor="#1b4cfa"></stop>
        <stop offset="1" stopColor="#183efb"></stop>
      </linearGradient>
      <path
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor="#3dbffd"></stop>
        <stop offset="1" stopColor="#1de9b6"></stop>
      </linearGradient>
      <path
